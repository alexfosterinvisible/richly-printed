...
scraped: 2025-11-19
cleaned: 2025-11-19
title: Rich Library - Layout
---

Layout
=========================================

Rich offers a [`Layout`](https://rich.readthedocs.io/en/latest/reference/layout.html#rich.layout.Layout) class which can be used to divide the screen area in to parts, where each part may contain independent content. It can be used with [Live Display](live.html#live) to create full-screen “applications” but may be used standalone.
...
This will draw a box the size of the terminal with some information regarding the layout. The box is a “placeholder” because we have yet to add any content to it. Before we do that, let’s create a more interesting layout by calling the [`split_column()`](https://rich.readthedocs.io/en/latest/reference/layout.html#rich.layout.Layout.split_column) method to divide the layout in to two sub-layouts:
...
You can also call [`update()`](https://rich.readthedocs.io/en/latest/reference/layout.html#rich.layout.Layout.update) to set or replace the current renderable:
...
See [fullscreen.py](https://github.com/willmcgugan/rich/blob/master/examples/fullscreen.py) for an example that combines [`Layout`](https://rich.readthedocs.io/en/latest/reference/layout.html#rich.layout.Layout) and [`Live`](https://rich.readthedocs.io/en/latest/reference/live.html#rich.live.Live) to create a fullscreen “application”.